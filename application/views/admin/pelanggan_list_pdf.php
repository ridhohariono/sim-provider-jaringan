        ...
        <div style="width: 100%;">
            <div style="width: 100%; background-color: rgb(224, 224, 224); padding: 1px 0px 5px 15px;">                
                <table style="width: 100%;">                    
                    <tr style="font-size: 20px;  text-align: center">
                        <td style="padding: 10px;">Daftar Pelanggan Pertanggal <?= tgl_indo($tgl_mulai) ?> s/d <?= tgl_indo($tgl_akhir) ?></td>
                    </tr>                                    
                </table>
            </div>
            <br/>            
            <table style="width: 100%; font-family: Arial, Helvetica, sans-serif; border-collapse: collapse;">
                <tr class="table_tr1">
                    ...
                    <td style="border: 1px solid black;">Datel</td>                    
                ...
                $total_amount = 0;
                ?>
                <?php if (!empty($pelanggan)): foreach ($pelanggan as $row) : ?>
